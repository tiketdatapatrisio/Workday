...
, tr_addons_flight as ( /*EDP 16 Nov 2021: new datasource for addons flight (rapid test)*/
  select
    ...
    , safe_cast(json_extract_scalar(hj,'$.value') as float64) as addons_value
    , json_extract_scalar(hj,'$.vendor') as addons_vendor
    , json_extract_scalar(hj,'$.desc') as addons_memo
  from
    tr
  left join
